...
url2 = "http://10.0.0.5/ctf_deploy2/kchal/Clyhbjgi/JTDIFDVIUX.php?hideGender=on&hideDayDoB=on&hideLastTwoDigitZIP=on&hideLastFourDigitZIP=on&hideLastFiveDigitZIP=on"
